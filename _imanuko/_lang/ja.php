...
store_version_name=Anuko タイムトラッカー
store_version_description=Anuko タイムトラッカーは、PHPで書かれたオープンソースのWebベースの時間追跡アプリケーションです。従業員や同僚がプロジェクトやタスクに費やした時間を追跡できます。実行にはApache、IISなどのWebサーバーが必要であり、データを保存するためにMySQLなどのデータベースが必要です。
