...
store_version_description=Anuko Time Tracker es una aplicación de seguimiento del tiempo basada en la web y de código abierto, escrita en PHP. Permite rastrear el tiempo que los empleados o colegas dedican a trabajar en proyectos y tareas. Necesita un servidor web como Apache, IIS, etc., para ejecutarse, y una base de datos como MySQL para almacenar los datos.
